...
{
 FILE *f;
 f=fopen("/home/yasmine/Projects/project12/src/agenda.txt","a+");
 if(f!=NULL)
{
...
column=gtk_tree_view_column_new_with_attributes(" id", renderer, "text",ID, NULL);				  				gtk_tree_view_append_column(GTK_TREE_VIEW(liste), column);
		...
		f= fopen("/home/yasmine/Projects/project12/src/agenda.txt", "r");
		if(f==NULL)
		{
			return;
		}
...
{	
	FILE*r, *s;
        agenda ag;
    	r=fopen("/home/yasmine/Projects/project12/src/agenda.txt","a+");
	s=fopen("/home/yasmine/Projects/project12/src/suppression.txt","a+");
	...
	fclose(r);
	fclose(s);
remove("/home/yasmine/Projects/project12/src/agenda.txt");
rename("/home/yasmine/Projects/project12/src/suppression.txt","/home/yasmine/Projects/project12/src/agenda.txt");
        }
}
