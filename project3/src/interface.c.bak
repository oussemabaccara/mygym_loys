...
create_window7 (void)
{
  ...
  button18 = gtk_button_new_with_mnemonic (_("Nos kin\303\251s"));
  gtk_widget_show (button18);
  gtk_fixed_put (GTK_FIXED (fixed10), button18, 100, 176);
  gtk_widget_set_size_request (button18, 216, 48);
...
create_window8 (void)
{
  ...
  gtk_widget_set_size_request (treeview4, 616, 376);
...
create_window11 (void)
{
  ...
  gtk_window_set_title (GTK_WINDOW (window11), _("Liste des kin\303\251s"));
  ...
  gtk_widget_set_size_request (treeview6, 536, 344);
