...
{
 FILE *f;
 f=fopen("/home/yasmine/Projects/project12/src/fiche.txt","a+");
 if(f!=NULL)
{
...
column=gtk_tree_view_column_new_with_attributes(" id", renderer, "text",ID, NULL);				  				gtk_tree_view_append_column(GTK_TREE_VIEW(liste), column);
		...
		f= fopen("/home/yasmine/Projects/project12/src/fiche.txt", "r");
		if(f==NULL)
		{
			return;
		}
...
{	
	FILE*r, *s;
        fiche fi;
    	r=fopen("/home/yasmine/Projects/project12/src/fiche.txt","a+");
	s=fopen("/home/yasmine/Projects/project12/src/suppressionfiche.txt","a+");
	...
	fclose(r);
	fclose(s);
remove("/home/yasmine/Projects/project12/src/fiche.txt");
rename("/home/yasmine/Projects/project12/src/suppressionfiche.txt","/home/yasmine/Projects/project12/src/fiche.txt");
        }
}
