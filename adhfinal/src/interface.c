...
create_window1 (void)
{
  ...
  gtk_fixed_put (GTK_FIXED (fixed2), button5, 128, 176);
...
create_window11 (void)
{
  ...
  gtk_window_set_title (GTK_WINDOW (window11), _("S\303\251ances de cure"));

  fixed14 = gtk_fixed_new ();
  gtk_widget_show (fixed14);
  gtk_container_add (GTK_CONTAINER (window11), fixed14);

  treeview6 = gtk_tree_view_new ();
  gtk_widget_show (treeview6);
  gtk_fixed_put (GTK_FIXED (fixed14), treeview6, 0, 0);
  gtk_widget_set_size_request (treeview6, 496, 304);

  button21 = gtk_button_new_with_mnemonic (_("Inscription/annulation"));
  gtk_widget_show (button21);
  gtk_fixed_put (GTK_FIXED (fixed14), button21, 136, 312);
  gtk_widget_set_size_request (button21, 200, 32);
  ...
  GLADE_HOOKUP_OBJECT (window11, fixed14, "fixed14");
  GLADE_HOOKUP_OBJECT (window11, treeview6, "treeview6");
...
create_window12 (void)
{
  ...
  gtk_container_add (GTK_CONTAINER (window12), fixed15);

  label14 = gtk_label_new (_("Entrer le num\303\251ro\n    de la s\303\251ance"));
  gtk_widget_show (label14);
  gtk_fixed_put (GTK_FIXED (fixed15), label14, 128, 32);
  gtk_widget_set_size_request (label14, 128, 56);

  entry5 = gtk_entry_new ();
  gtk_widget_show (entry5);
  gtk_fixed_put (GTK_FIXED (fixed15), entry5, 112, 88);
  gtk_widget_set_size_request (entry5, 160, 27);
  gtk_entry_set_invisible_char (GTK_ENTRY (entry5), 8226);

  button22 = gtk_button_new_with_mnemonic (_("Inscription"));
  gtk_widget_show (button22);
  gtk_fixed_put (GTK_FIXED (fixed15), button22, 72, 128);
  gtk_widget_set_size_request (button22, 112, 32);

  button23 = gtk_button_new_with_mnemonic (_("annulation"));
  gtk_widget_show (button23);
  gtk_fixed_put (GTK_FIXED (fixed15), button23, 216, 128);
  gtk_widget_set_size_request (button23, 104, 32);

  label15 = gtk_label_new ("");
  gtk_widget_show (label15);
  gtk_fixed_put (GTK_FIXED (fixed15), label15, -8, 160);
  gtk_widget_set_size_request (label15, 440, 168);
  ...
  GLADE_HOOKUP_OBJECT (window12, fixed15, "fixed15");
  GLADE_HOOKUP_OBJECT (window12, label14, "label14");
  GLADE_HOOKUP_OBJECT (window12, entry5, "entry5");
  GLADE_HOOKUP_OBJECT (window12, button22, "button22");
  GLADE_HOOKUP_OBJECT (window12, button23, "button23");
  GLADE_HOOKUP_OBJECT (window12, label15, "label15");
